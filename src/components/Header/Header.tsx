            ...
            <div className="container mx-auto px-4 py-4">
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex items-center justify-center gap-6 text-sm">
                        ...
                        {/* API Monitor Indicator */}
                        <div className="bg-gray-50 border border-gray-200 px-3 py-2 rounded-lg text-xs">
                            <div className="text-gray-600 font-medium">📊 API Monitor</div>
                            <div className="text-gray-800">Check console for details</div>
                        </div>
                    </div>
                </div>
            </div>
